  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-[60vh] p-4">
      <div className="max-w-md w-full flex flex-col gap-6 items-center">
        <h1 className="text-2xl font-bold mb-2">ShopSmart Forum</h1>
        <div className="w-full flex flex-col gap-2 bg-white rounded-lg shadow p-4 min-h-[300px] max-h-[400px] overflow-y-auto">
          {loading ? (
            <div>Loading...</div>
          ) : chats.length === 0 ? (
        ...
        <Link
          href="/"
          className="mt-4 inline-block px-4 py-2 bg-gray-200 text-gray-800 rounded-lg font-semibold hover:bg-gray-300 transition-colors text-center shadow"
        >
          Back to Home
        </Link>
      </div>
